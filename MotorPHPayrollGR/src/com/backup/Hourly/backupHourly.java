 ...
 * @author ongoj
 */
public class backupHourly {

    private static final String SOURCE_DIR = "src/com/csv/";
    private static final String BACKUP_DIR = "src/com/backup/Hourly/";
    ...
    public static void runBackup() {
        try {
            ...
            System.out.println("Hourly backup completed at: " + timestamp);
        } catch (IOException e) {
            System.err.println("Error during hourly backup: " + e.getMessage());
        }
    }
